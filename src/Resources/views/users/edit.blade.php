<x-aboleon.framework-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edition d'un compte {{ $account->userTypes()['admin']['label'] }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="row m-3">
                    <div class="col">
                        <form method="post" action="{{ route('aboleon.framework.users.update', $account->id) }}">
                            @method('put')
                            @csrf
                            <fieldset>
                                <legend>Compte {{ $account->names() }}</legend>
                                <div>
                                    <div class="row mb-4">
                                        <div class="col-lg-6">
                                            <h4>Identité</h4>
